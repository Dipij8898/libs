         ...
         <div class=container>
            ...
            <div class="collapse navbar-collapse navbar-collapse-overlay" id=navbar-main-collapse>
               ...
               <ul class="navbar-nav ml-lg-auto">
                  <li class="nav-item nav-item-spaced d-none d-lg-block"><a class=nav-link href="/pages/index.html">Home
                     </a></li>
                  ...
                  <li class="nav-item nav-item-spaced d-none d-lg-block"><a class=nav-link href="/pages/mybooks.html">My
                        books</a>
                  </li>
                  <li class="nav-item nav-item-spaced d-none d-lg-block"><a class=nav-link
               ...
               <ul class="navbar-nav align-items-lg-center d-none d-lg-flex ml-lg-auto">
                  ...
                  <li class="nav-item nav-item-spaced dropdown dropdown-animate" data-toggle=hover>
                     <a class="btn btn-sm btn-primary btn-icon ml-3" href=# role=button data-toggle=dropdown
                              ...
                              <div class="row p-3 mx-3">
                                 <div class=col-md-6>
                                    <div class=form-group>
                                       ...
                                       <input class="form-control" type="text" placeholder="ID" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" />
