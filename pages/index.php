        ...
        <nav class="navbar navbar-main navbar-expand-lg navbar-light" id=navbar-main>
            <div class=container> 
                <a class=navbar-brand>
                    <img alt="Image placeholder" src="../../libs/assets/img/brand/p_logo.png" id=navbar-logo>
                </a>
    ...
    <div class="container"> 
        <div class="row row-grid align-items-center">
            <div class="col-12 col-md-5 col-lg-6 order-md-2">
                ...
                src="../../libs/assets/img/svg/illustrations/illustration-2.svg" class="img-fluid mw-md-120">
                </figure>
            </div>
