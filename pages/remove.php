...
<!-- requestbar start -->
                    <div class=col-lg-9>
                        <h2 class="mb-4 text-center text-white">Delete books</h2>
                        <form method="POST" action="submit1">
                            <div class="form-group bg-neutral rounded-pill mb-0 px-2 py-2 shadow">
                                <div class=row>
                                    ...
                                    <div class=col-auto><button type=button
                                            class="btn btn-block btn-warning rounded-pill">Delete</button></div>
                                </div>
                            </div>
                        </form>
                    </div>
...
if(isset($_POST['submit1']))
{
    ...
    {
        mysqli_query($db,"INSERT INTO record Values('$_SESSION[username]', '$_POST[bookid]', '', '', '');");
        ?>
