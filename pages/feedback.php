                    ...
                    <div class=card>
                        <div class="list-group list-group-flush">
                            <a href=#borrow_return_books data-scroll-to data-scroll-to-offset=50
                                ...
                                <div ><i data-feather=layout class="mr-2 text-primary"></i> <span>Borrow / Return books</span></div>
                                <div class="text-primary"><i data-feather=chevron-right></i></div>
                            </a>
                            <a href=#request_book data-scroll-to data-scroll-to-offset=50
                                class="list-group-item list-group-item-action d-flex justify-content-between">
                                <div><i data-feather=sliders class="mr-2 text-primary"></i> <span>Request books</span></div>
                                <div class="text-primary"><i data-feather=chevron-right></i></div>
                            </a>
            ...
            <div class="col-lg-8 ml-lg-auto">
                <div class=mb-5>
                    ...
                    <div id=accordion-1 class="accordion accordion-spaced">
                        <div class=card>
                            ...
                            <div id=collapse-1-1 class=collapse aria-labelledby=heading-1-1 data-parent=#accordion-1>
                                <div class=card-body>
                                    <p>You can borrow 3 books at a time.If you want to borrow more books you can borrow
                            ...
                            <div id=collapse-1-3 class=collapse aria-labelledby=heading-1-3 data-parent=#accordion-1>
                                <div class=card-body>
                                    <p>You should check the book before borrowing it , If you found anything you can
                                        tell that to theh libary staff before borrowing it they will note that in the
                    ...
                    <div class="text-right py-4"><a href=#borrow_return_books data-scroll-to data-scroll-to-offset=50
                            class="text-sm font-weight-bold">Back to top<i data-feather=chevron-up class=ml-2></i></a>
                    </div>
                </div>
                <div class=mb-md>
                    ...
                    <div id=accordion-2 class="accordion accordion-spaced">
                        <div class=card>
                            ...
                            <div id=collapse-2-1 class=collapse aria-labelledby=heading-2-1 data-parent=#accordion-2>
                                <div class=card-body>
                                    <p>It depends on the book If the book is available easily we will surely add that
                                        book to our collection But if that book is rare it might take a bit longer time
                        ...
                        <div class=card>
                            ...
                            <div id=collapse-2-2 class=collapse aria-labelledby=heading-2-2 data-parent=#accordion-2>
                                <div class=card-body>
                                    <p>It generally take 5-10 business days but sometimes it might take more than that
