            ...
            <div class=modal-body>
               ...
               <div class=px-4>
                  ...
                  <div class="d-flex mb-5">
                     <div class="col-4 text-center"><a href=# class="h5 font-weight-bolder text-warning mb-0">5</a>
                        <span class="d-block text-sm">Borrowed</span></div>
                     <div class="col-4 text-center"><a href=# class="h5 font-weight-bolder text-warning mb-0">3</a>
                        <span class="d-block text-sm">Purchased</span></div>
                     <div class="col-4 text-center"><a href=# class="h5 font-weight-bolder text-warning mb-0">20</a>
                        <span class="d-block text-sm">Points</span></div>
                  </div>
                  <div class=mb-5>
                     <div class="mt-4 pt-4 border-top">
                        <div class="row align-items-center mb-3">
                           <div class=col-auto>
                              <div class="icon icon-shape bg-soft-warning text-warning"><i class="fas fa-image"></i>
                              </div>
                           </div>
                           <div class="col pl-0">
                        ...
                        <div class="row align-items-center mb-3">
                           <div class=col-auto>
                              <div class="icon icon-shape bg-soft-success text-success"><i class="fas fa-file-alt"></i>
                              </div>
                           </div>
                           <div class="col pl-0">
                        ...
                        <div class="row align-items-center">
                           <div class=col-auto>
                              <div class="icon icon-shape bg-soft-primary text-primary"><i class="fas fa-question"></i>
                              </div>
                           </div>
                           <div class="col pl-0">
   ...
   <div class="pt-3 slice slice-sm bg-section-secondary">
      <div class=container>
         <div class="row justify-content-center">
            <div class="col-lg-9">
               <div class=card>
                  <ul class="nav nav-tabs navi-tabs justify-content-center">
                     <li class="nav-item m-4"><a data-toggle="tab" href="#add" class="text-dark nav-link active">
                           <h4><b>Add
                                 Book</b></h4>
                        </a></li>
                     <li class="nav-item m-4"><a data-toggle="tab" href="#rem" class="text-dark nav-link">
                           <h4><b>Remove Book</b></h4>
                        </a></li>
                  </ul>
                  <div class=card-body>
                     <p class="mb-4 mt-3 h5 mx-5">Enter the Book Info :-</p>
                     <form>
                        <div class="tab-content">
                              ...
                              <div class="row p-3 mx-3">
                                 <div class=col-md-6>
                                    <div class=form-group>
                                       ...
                                       <small class="form-text text-muted mt-2">Only if you are adding book which is
                                          already
                                          in the library.</small>
                                    </div>
                                 </div>
                                 <div class=col-md-6>
                                    <div class=form-group>
                                       <label class="form-control-label">Book Quantity</label>
                                       <input class=form-control type=number placeholder="Quantity" min=0>
                                    </div>
                                 </div>
                              </div>
                              <div class="row justify-content-center">
                                 <button type=button class="btn btn-sm btn-primary">Add Book</button>
                              </div>
                           </div>
                           <div id="rem" class="tab-pane fade">
                              <div class="row p-3 mx-3">
                                 ...
                                 <div class=col-md-6>
                                    <div class=form-group>
                                       <label class=form-control-label>Book Qunatity</label>
                                       <input class=form-control type=number placeholder="Quantity" min="0">
                                    </div>
                                 </div>
                              </div>
                              <div class="row justify-content-center">
                                 <button type=button class="btn btn-sm btn-danger">Remove Book</button>
                              </div>
                           </div>
                        </div>
                     </form>
